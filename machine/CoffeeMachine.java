...
public class CoffeeMachine {
    ...
    //machine starting stock
    int waterStock = 400;
    int milkStock = 540;
    int beanStock = 120;
    int cupStock = 9;
    int moneyStock = 550;
    //resources needed for products sold
    private static final int waterEs = 250;
    private static final int beanEs = 16;
    private static final int moneyEs = 4;
    private static final int waterLa = 350;
    private static final int milkLa = 75;
    private static final int beanLa = 20;
    private static final int moneyLa = 7;
    private static final int waterCap = 200;
    private static final int milkCap = 100;
    private static final int beanCap = 12;
    private static final int moneyCap = 6;
    //machine on
    ...
    public void machineProcess(String action) {
        switch (MachineState.valueOf(action)) {
            case buy:
    ...
    public static void main(String[] args) {
        ...
        while (!stopped) {
            ...
            coffeeMachine.machineProcess(action);
        }
    }
}
